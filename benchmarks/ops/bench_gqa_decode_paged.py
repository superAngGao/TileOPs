...
_GQA_DECODE_PAGED_BENCH_PARAMS = [
    # Paged decode: real serving scenarios with batched requests
    # page_size=64 (TileOPs minimum)
    pytest.param(32, 32, 8, 4096, 128, 64, torch.float16, True, id="serving-8b-p64"),
    pytest.param(8, 32, 8, 32768, 128, 64, torch.float16, True, id="serving-8b-long"),
    pytest.param(64, 32, 8, 2048, 128, 64, torch.float16, True, id="throughput-8b"),
    ...
    pytest.param(4, 128, 8, 4096, 128, 256, torch.float16, True, id="serving-405b"),
