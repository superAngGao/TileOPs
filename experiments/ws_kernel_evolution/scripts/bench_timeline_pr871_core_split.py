#!/usr/bin/env python3
"""Measure PR 871 steady-state core with finer-grained splits.
...
- `rescale_before_pv`: explicit `rescale(acc_o, ss)` before PV
...
if __name__ == "__main__":
    ...
    print(f"Building kernel ({args.variant} core split)...")
