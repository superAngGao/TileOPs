        ...
        for (int sub_idx_1 = 0; sub_idx_1 < 2; ++sub_idx_1) {
          ...
          *(float2*)(sm_1 + 0) = make_float2(broadcast_var_2, broadcast_var_2);
          for (int n_idx_1 = 0; n_idx_1 < ((((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) + (sub_idx_1 * (31 - (((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2)))) + 1); ++n_idx_1) {
            ...
            if (n_idx_1 == 0) {
              ...
              *(float2*)(sm_1 + 0) = make_float2(broadcast_var_4, broadcast_var_4);
              ...
              int64_t t1 = clk::read_clock();
              #pragma unroll
              for (int i_11 = 0; i_11 < 64; ++i_11) {
                acc_o_1[i_11] = (acc_o_1[i_11] * ss_1[((i_11 & 3) >> 1)]);
              }
              ...
              if (n_idx_1 == (((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) + (sub_idx_1 * (31 - (((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2))))) {
                ...
                for (int i_12 = 0; i_12 < 64; ++i_12) {
                  float condval_1;
                  if (((((((n_idx_1 * 128) + ((i_12 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_12 & 1)) + 64) <= (((((((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) * 128) + ((sub_idx_1 * (31 - (((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2))) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_12 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
                    condval_1 = acc_s_1[i_12];
                  } else {
                    condval_1 = -CUDART_INF_F;
                  }
                  acc_s_1[i_12] = condval_1;
                }
              }
              ...
              *(float2*)(sm_1 + 0) = make_float2(broadcast_var_5, broadcast_var_5);
              ...
              for (int i_13 = 0; i_13 < 2; ++i_13) {
                sm_1_clear_1[i_13] = -CUDART_INF_F;
                #pragma unroll
                for (int rv_2 = 0; rv_2 < 32; ++rv_2) {
                  sm_1_clear_1[i_13] = max(sm_1_clear_1[i_13], acc_s_1[((((rv_2 & 15) * 4) + (i_13 * 2)) + (rv_2 >> 4))]);
                }
                sm_1_clear_1[i_13] = tl::AllReduce<tl::MaxOp, 4, 1, 128, tl::NamedBarrier<128>>::run(sm_1_clear_1[i_13]);
                sm_1[i_13] = max(sm_1[i_13], sm_1_clear_1[i_13]);
              }
              #pragma unroll
              for (int i_14 = 0; i_14 < 2; ++i_14) {
                sm_1[i_14] = max(sm_1[i_14], smp_1[i_14]);
              }
              #pragma unroll
              for (int i_15 = 0; i_15 < 2; ++i_15) {
                sm_1[i_15] = max(sm_1[i_15], -0x1.2ced32a16a1b1p+126f/*-1.000000e+38*/);
              }
              #pragma unroll
              for (int i_16 = 0; i_16 < 2; ++i_16) {
                ss_1[i_16] = exp2f(((smp_1[i_16] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (sm_1[i_16] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
              }
              #pragma unroll
              for (int i_17 = 0; i_17 < 64; ++i_17) {
                acc_s_1[i_17] = exp2f(((acc_s_1[i_17] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (sm_1[((i_17 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
              }
              #pragma unroll
              for (int i_18 = 0; i_18 < 2; ++i_18) {
                ssum_1[i_18] = 0x0p+0f/*0.000000e+00*/;
                #pragma unroll
                for (int rv_3 = 0; rv_3 < 32; ++rv_3) {
                  ssum_1[i_18] = (ssum_1[i_18] + acc_s_1[((((rv_3 & 15) * 4) + (i_18 * 2)) + (rv_3 >> 4))]);
                }
                ssum_1[i_18] = tl::AllReduce<tl::SumOp, 4, 1, 128, tl::NamedBarrier<128>>::run(ssum_1[i_18]);
              }
              #pragma unroll
              for (int i_19 = 0; i_19 < 2; ++i_19) {
                ls_1[i_19] = ((ls_1[i_19] * ss_1[i_19]) + ssum_1[i_19]);
              }
              ...
              gi_vc1 = (gi_vc1 + 1);
              clk::clock_accum((&(timing[0])), (t1 - t0));
              clk::clock_accum((&(timing[1])), (t2 - t1));
          ...
          for (int i_21 = 0; i_21 < 64; ++i_21) {
            acc_o_1[i_21] = (acc_o_1[i_21] * ss_1[((i_21 & 3) >> 1)]);
          }
          v_full[0].wait((gi_vc1 & 1));
          if ((gi_vc1 % 2) == 0) {
          ...
          for (int i_22 = 0; i_22 < 64; ++i_22) {
            acc_o_1[i_22] = (acc_o_1[i_22] / ls_1[((i_22 & 3) >> 1)]);
          }
          #pragma unroll
          for (int i_23 = 0; i_23 < 8; ++i_23) {
            tl::ptx_stmatrix_x4((&(((half_t*)buf_dyn_shmem)[((((((((i_23 >> 2) * 4096) + (((((int)threadIdx.x) & 127) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_23 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_23 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 65536)])), __pack_half2(((half_t)acc_o_1[(i_23 * 8)]), ((half_t)acc_o_1[((i_23 * 8) + 1)])), __pack_half2(((half_t)acc_o_1[((i_23 * 8) + 2)]), ((half_t)acc_o_1[((i_23 * 8) + 3)])), __pack_half2(((half_t)acc_o_1[((i_23 * 8) + 4)]), ((half_t)acc_o_1[((i_23 * 8) + 5)])), __pack_half2(((half_t)acc_o_1[((i_23 * 8) + 6)]), ((half_t)acc_o_1[((i_23 * 8) + 7)])));
          }
          ...
          for (int i_24 = 0; i_24 < 2; ++i_24) {
            ls_1[i_24] = (log2f(ls_1[i_24]) + (sm_1[i_24] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/));
          }
          if ((((int)threadIdx.x) % 4) == 0) {
            #pragma unroll
            for (int i_25 = 0; i_25 < 2; ++i_25) {
              lse[((((((((((((w_1 * 132) + ((int)blockIdx.x)) / 4096) * 32768) + (((((w_1 * 132) + ((int)blockIdx.x)) % 4096) / 128) * 32768)) + ((((w_1 * 132) + ((int)blockIdx.x)) % 8) * 4096)) + (((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) * 128)) + ((sub_idx_1 * (31 - (((((w_1 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2))) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (i_25 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)] = ls_1[i_25];
            }
          }
        }
      }
      ...
      for (int w_2 = 0; w_2 < 32; ++w_2) {
        ...
        for (int sub_idx_2 = 0; sub_idx_2 < 2; ++sub_idx_2) {
          ...
          for (int i_26 = 0; i_26 < 16; ++i_26) {
            ...
            *(float4*)(acc_o_2 + (i_26 * 4)) = make_float4(broadcast_var_6, broadcast_var_6, broadcast_var_6, broadcast_var_6);
          }
          ...
          *(float2*)(sm_2 + 0) = make_float2(broadcast_var_8, broadcast_var_8);
          for (int n_idx_2 = 0; n_idx_2 < ((((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) + (sub_idx_2 * (31 - (((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2)))) + 1); ++n_idx_2) {
            ...
            for (int i_27 = 0; i_27 < 16; ++i_27) {
              ...
              *(float4*)(acc_s_2 + (i_27 * 4)) = make_float4(broadcast_var_9, broadcast_var_9, broadcast_var_9, broadcast_var_9);
            }
            if ((gi_kc2 % 2) == 0) {
            ...
            for (int i_28 = 0; i_28 < 64; ++i_28) {
              acc_o_2[i_28] = (acc_o_2[i_28] * ss_2[((i_28 & 3) >> 1)]);
            }
            if (0 < n_idx_2) {
            ...
            if (n_idx_2 == (((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) + (sub_idx_2 * (31 - (((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2))))) {
              ...
              for (int i_29 = 0; i_29 < 64; ++i_29) {
                float condval_2;
                if (((((((n_idx_2 * 128) + ((i_29 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_29 & 1)) + 64) <= (((((((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) * 128) + ((sub_idx_2 * (31 - (((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2))) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (((i_29 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
                  condval_2 = acc_s_2[i_29];
                } else {
                  condval_2 = -CUDART_INF_F;
                }
                acc_s_2[i_29] = condval_2;
              }
            }
            ...
            *(float2*)(sm_2 + 0) = make_float2(broadcast_var_10, broadcast_var_10);
            ...
            for (int i_30 = 0; i_30 < 2; ++i_30) {
              sm_2_clear[i_30] = -CUDART_INF_F;
              #pragma unroll
              for (int rv_4 = 0; rv_4 < 32; ++rv_4) {
                sm_2_clear[i_30] = max(sm_2_clear[i_30], acc_s_2[((((rv_4 & 15) * 4) + (i_30 * 2)) + (rv_4 >> 4))]);
              }
              sm_2_clear[i_30] = tl::AllReduce<tl::MaxOp, 4, 1, 256, tl::NamedBarrier<128>>::run(sm_2_clear[i_30]);
              sm_2[i_30] = max(sm_2[i_30], sm_2_clear[i_30]);
            }
            #pragma unroll
            for (int i_31 = 0; i_31 < 2; ++i_31) {
              sm_2[i_31] = max(sm_2[i_31], smp_2[i_31]);
            }
            #pragma unroll
            for (int i_32 = 0; i_32 < 2; ++i_32) {
              sm_2[i_32] = max(sm_2[i_32], -0x1.2ced32a16a1b1p+126f/*-1.000000e+38*/);
            }
            #pragma unroll
            for (int i_33 = 0; i_33 < 2; ++i_33) {
              ss_2[i_33] = exp2f(((smp_2[i_33] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (sm_2[i_33] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
            }
            #pragma unroll
            for (int i_34 = 0; i_34 < 64; ++i_34) {
              acc_s_2[i_34] = exp2f(((acc_s_2[i_34] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (sm_2[((i_34 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
            }
            #pragma unroll
            for (int i_35 = 0; i_35 < 2; ++i_35) {
              ssum_2[i_35] = 0x0p+0f/*0.000000e+00*/;
              #pragma unroll
              for (int rv_5 = 0; rv_5 < 32; ++rv_5) {
                ssum_2[i_35] = (ssum_2[i_35] + acc_s_2[((((rv_5 & 15) * 4) + (i_35 * 2)) + (rv_5 >> 4))]);
              }
              ssum_2[i_35] = tl::AllReduce<tl::SumOp, 4, 1, 256, tl::NamedBarrier<128>>::run(ssum_2[i_35]);
            }
            #pragma unroll
            for (int i_36 = 0; i_36 < 2; ++i_36) {
              ls_2[i_36] = ((ls_2[i_36] * ss_2[i_36]) + ssum_2[i_36]);
            }
            tl::wait_wgmma<0>();
            tl::warpgroup_fence_operand(reinterpret_cast<float*>(acc_o_2 + 0), 64);
            if (0 < n_idx_2) {
          ...
          for (int i_39 = 0; i_39 < 64; ++i_39) {
            acc_o_2[i_39] = (acc_o_2[i_39] / ls_2[((i_39 & 3) >> 1)]);
          }
          #pragma unroll
          for (int i_40 = 0; i_40 < 8; ++i_40) {
            tl::ptx_stmatrix_x4((&(((half_t*)buf_dyn_shmem)[((((((((i_40 >> 2) * 4096) + (((((int)threadIdx.x) & 127) >> 5) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_40 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_40 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 73728)])), __pack_half2(((half_t)acc_o_2[(i_40 * 8)]), ((half_t)acc_o_2[((i_40 * 8) + 1)])), __pack_half2(((half_t)acc_o_2[((i_40 * 8) + 2)]), ((half_t)acc_o_2[((i_40 * 8) + 3)])), __pack_half2(((half_t)acc_o_2[((i_40 * 8) + 4)]), ((half_t)acc_o_2[((i_40 * 8) + 5)])), __pack_half2(((half_t)acc_o_2[((i_40 * 8) + 6)]), ((half_t)acc_o_2[((i_40 * 8) + 7)])));
          }
          tl::fence_proxy_async();
          ...
          for (int i_41 = 0; i_41 < 2; ++i_41) {
            ls_2[i_41] = (log2f(ls_2[i_41]) + (sm_2[i_41] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/));
          }
          if ((((int)threadIdx.x) % 4) == 0) {
            #pragma unroll
            for (int i_42 = 0; i_42 < 2; ++i_42) {
              lse[((((((((((((w_2 * 132) + ((int)blockIdx.x)) / 4096) * 32768) + (((((w_2 * 132) + ((int)blockIdx.x)) % 4096) / 128) * 32768)) + ((((w_2 * 132) + ((int)blockIdx.x)) % 8) * 4096)) + (((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) * 128)) + ((sub_idx_2 * (31 - (((((w_2 * 132) + ((int)blockIdx.x)) % 128) / 8) * 2))) * 128)) + ((((int)threadIdx.x) >> 5) * 16)) + (i_42 * 8)) + ((((int)threadIdx.x) & 31) >> 2)) - 64)] = ls_2[i_42];
            }
          }
        }
      }
