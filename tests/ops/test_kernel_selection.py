...
def test_bshd_tail_requests_respect_specialization_safety(
    ctor: dict, expected: str
) -> None:
...
@pytest.mark.parametrize(("ctor", "call"), [
    ...
    pytest.param({"backend": "auto", "is_causal": False}, {"is_fp8": True},
                 id="auto-fp8-moved-to-dense"),
